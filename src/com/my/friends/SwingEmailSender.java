...
//	private JTextField fieldTo = new JTextField(30);
    ...
    public SwingEmailSender() {
        super("Friends Application - Compose Email to the Post Owner");
        textAreaMessage.setText("Hey, contact me at :" + GetUserID.currentUserEmailID);
    ...
    private void buttonSendActionPerformed(ActionEvent event) {
        ...
        String toAddress = GetUserID.OwnerEmailid; 				// the toAddress
        String subject = fieldSubject.getText();					// Subject
        String message = textAreaMessage.getText() + 				// Appending text along with the message body
        		" <br><br><br><br><br>" + 
        		"<font color = red><i><b><h4> PLEASE DO NOT REPLY."
        		+ " This e-mail is sent from Friends Application."
        		+ " Kindly contact the sender.<h4></font></b></i>";
...
//         
     ...
     // this acts like main method which is called from the FreindsMain.java 
