...
public class TableSelectDialog extends JDialog {
	...
	public TableSelectDialog() {
		...
		JLabel lblNewLabel = new JLabel("Please select a row in the table to view or delete posts");
		GroupLayout gl_contentPanel = new GroupLayout(contentPanel);
		gl_contentPanel.setHorizontalGroup(
			gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 330, Short.MAX_VALUE)
					.addContainerGap())
		);
